...
const SingleTripForm = ({
  ...
  return (
    <form onSubmit={handleSubmit} className='form-container'>
      ...
      <div className="form-row  statusdiv" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <label className="label">
          Status:
          <br />
          <br />
      ...
      <div className='submitdiv'>
        ...
        <button type="button" className="delete-button" onClick={() => close(!open)}>
          Cancel
        </button>
      </div>
